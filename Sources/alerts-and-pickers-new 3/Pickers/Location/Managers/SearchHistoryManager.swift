...
extension Location {
	...
	func toDefaultsDic() -> NSDictionary? {
        ...
        if placemark.postalCode != nil && ((placemark.location?.coordinate.toDefaultsDic()) != nil) {
            let formatter = CNPostalAddressFormatter()
            let postalAddress = placemark.postalAddress!
            let placemarkCoordinatesDic:AnyObject = placemark.location?.coordinate.toDefaultsDic() as AnyObject
