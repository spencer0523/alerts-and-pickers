...
extension UIAlertController {
    ...
    open func addLocationPicker(location: Location? = nil, completion: @escaping LocationPickerViewController.CompletionHandler) {
...
public final class LocationPickerViewController: UIViewController {
    ...
    lazy var locationButton: Button = {
        ...
        $0.maskToBounds = true
        $0.cornerRadius = 22
        $0.setImage(UIImage(named: "geolocation", in: Bundle(for: Self.self), compatibleWith: nil), for: UIControl.State())
